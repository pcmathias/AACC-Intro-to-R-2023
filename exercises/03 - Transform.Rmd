...
A. You are wanting to confirm a reference interval for women over 50 for alkaline phophatase. Find every test for patients over age 50. The column in which age is found is named `age`. Assign the new data frame to the object `biochem_3a`.
...
B. We also would only like to include outpatients? Find all of the alkaline phosphtase testing where the patient type (`demo_group`) is equal to "outpatient". Assign the new data frame to the object `biochem_3b`.
