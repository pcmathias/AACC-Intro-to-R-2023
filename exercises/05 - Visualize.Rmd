...
```{r}
lyte_data <- biochem |> 
  filter(test %in% c('sodium_mmol_l', 'potassium_mmol_l', 'chloride_mmol_l', 'bicarbonate_mmol_l'))
View(lyte_data)
```
...
Now try to figure out how you would modify the code above so it draws a frequency polygon instead of histogram. One resource is the ggplot cheatsheet that can be found at 
