...
chol_gluc_comparison <- biochem |> 
  filter(test %in% c('cholesterol_refrigerated_serum_mg_d_l', 'glucose_refrigerated_serum_mg_d_l')) |> 
  select(mrn, gender, age, pregnancy_status_at_exam, test, value) |> 
  pivot_wider(names_from = test, values_from = value)
ggplot(data = chol_gluc_comparison) +
  geom_point(aes(x = cholesterol_refrigerated_serum_mg_d_l, y = glucose_refrigerated_serum_mg_d_l))
```
